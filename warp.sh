...
Install_wgcf() {
    curl -fsSL https://cdn.jsdelivr.net/gh/eramicro/warp.sh/wgcf.sh | bash
}
...
Install_WireGuardGo() {
    ...
    openvz | lxc*)
        curl -fsSL https://cdn.jsdelivr.net/gh/eramicro/warp.sh/wireguard-go.sh | bash
        ;;
    *)
...
Menu_Title="${FontColor_Yellow_Bold}Cloudflare WARP"
...
${Menu_Title}
 ...
 ${FontColor_Green_Bold}8${FontColor_Suffix}. 退出脚本
"
    unset MenuNumber
    read -p "请输入选项: " MenuNumber
    echo
